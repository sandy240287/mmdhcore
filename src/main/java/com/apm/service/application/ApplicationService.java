...
public class ApplicationService {
	...
	public @ResponseBody APMResponse addApplicationByOrganization(@PathVariable(value = "orgId") Long orgId,
		...
		return new APMResponse("APPLICATION_CREATED", "Application is added successfully").success();
	...
	public @ResponseBody APMResponse updateApplicationByOrgId(@PathVariable(value = "orgId") Long orgId,
		...
		applicationRepo.save(application);
		return new APMResponse("APPLICATION_UPDATED", "Application is updated successfully").success();
	}
	...
	public @ResponseBody APMResponse deleteApplicationByOrgId(@PathVariable(value = "orgId") Long orgId,
			@PathVariable(value = "applicationId") Long applicationId) {

		// get application from the repo
		Application application = applicationRepo.getOne(applicationId);
		applicationRepo.delete(application);
		return new APMResponse("APPLICATION_DELETED", "Application is deleted successfully").success();
	}
	...
	@ResponseBody
	public APMResponse applicationExistsResponse(RecordExistsException ex, HttpServletResponse response) {
