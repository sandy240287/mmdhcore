...
public class FunctionService {
	...
	public @ResponseBody MMDHResponse addFunctionByDivision(@PathVariable(value = "orgId") Long orgId,
		...
		return new MMDHResponse("FUNCTION_CREATED", "Function is added successfully").success();
	...
	public @ResponseBody MMDHResponse updateFunctionByDivision(@PathVariable(value = "orgId") Long orgId,
			@PathVariable(value = "divisionId") Long divisionId, @PathVariable(value = "functionId") Long functionId,
		...
		// now save the Function
		functionRepo.save(function);
		return new MMDHResponse("FUNCTION_UPDATED", "Function is updated successfully").success();
	}

	// DELETE Function of the Division
	@RequestMapping(value = API_FUNCTIONS_PATH
			+ "/{functionId}", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.DELETE)
	public @ResponseBody MMDHResponse deleteFunctionByOrgId(@PathVariable(value = "orgId") Long orgId,
			@PathVariable(value = "divisionId") Long divisionId, @PathVariable(value = "functionId") Long functionId) {
		...
		return new MMDHResponse("FUNCTION_DELETED", "Function is deleted successfully").success();
	}
	...
	@ResponseBody
	public MMDHResponse functionExistsResponse(RecordExistsException ex, HttpServletResponse response) {
